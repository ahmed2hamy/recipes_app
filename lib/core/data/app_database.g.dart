    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `recipes` (`id` TEXT NOT NULL, `fats` TEXT NOT NULL, `name` TEXT NOT NULL, `time` TEXT NOT NULL, `image` TEXT NOT NULL, `weeks` TEXT NOT NULL, `carbos` TEXT NOT NULL, `fibers` TEXT NOT NULL, `country` TEXT NOT NULL, `calories` TEXT NOT NULL, `headline` TEXT NOT NULL, `keywords` TEXT NOT NULL, `products` TEXT NOT NULL, `proteins` TEXT NOT NULL, `favorites` INTEGER NOT NULL, `difficulty` INTEGER NOT NULL, `description` TEXT NOT NULL, `highlighted` INTEGER NOT NULL, `ingredients` TEXT NOT NULL, `deliverableIngredients` TEXT NOT NULL, PRIMARY KEY (`id`))');
        await database.execute(
